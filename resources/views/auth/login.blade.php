                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password" id="password" required
                            class="w-full rounded-2xl bg-slate-50 border border-slate-200 pl-12 pr-12 py-4 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-indigo-100 focus:border-indigo-500 transition-all font-mono"
                            placeholder="••••••••">
                        <button type="button" onclick="togglePassword()" title="Parolni ko'rsatish/yashirish" class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-indigo-600 focus:outline-none transition-colors">
                            ...
                            <svg id="icon-eye-slash" class="h-5 w-5 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
